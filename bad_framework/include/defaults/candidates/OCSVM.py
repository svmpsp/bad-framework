...
class OCSVM:
    ...
    Parameters:
    - kernel: (string) kernel function to use (defaults to 'rbf'). It supports 'linear', 'poly', 'rbf', 'sigmoid',
    'precomputed' or a callable.
    - nu: (float) threshold on the number of training errors/support vectors to use (defaults to 0.5). Should be
    between (0.0, 1.0].
    ...
    library (https://pyod.readthedocs.io/en/latest/pyod.models.html#module-pyod.models.ocsvm)
    """
